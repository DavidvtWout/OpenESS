import { power, energy } from './api.js';
...
function getHoursSelect() {
    return /** @type {HTMLSelectElement} */ (document.getElementById('hours-select'));
}
...
function getAggregateSelect() {
    return /** @type {HTMLSelectElement} */ (document.getElementById('aggregate-select'));
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    getHoursSelect().addEventListener('change', (e) => {
        savePagePref('debug', 'hours', /** @type {HTMLSelectElement} */ (e.target).value);
        loadAllCharts();
    });
    getAggregateSelect().addEventListener('change', (e) => {
        savePagePref('debug', 'aggregate', /** @type {HTMLSelectElement} */ (e.target).value);
        loadAllCharts();
    });
